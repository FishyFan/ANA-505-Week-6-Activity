...
iris_train <- rbind(iris_setosa[1:35,], iris_versicolor[1:35,], iris_virginica[1:35,]) #with 35 from each and 70/30 test/train split aggregating the three types of species
...
#How did the model do? Compared to the other models, this one didn't perform as well as SVM but was relatively accurate at the 70/30 test/train split.
#TASK: What percent of cases were correctly classified? 95.6 percent accuracy was achieved while running this for the second time.
