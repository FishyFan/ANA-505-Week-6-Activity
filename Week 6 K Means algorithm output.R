...
#How did the model do? Compared to the other algorithms, this is the least accurate model which can be predicted
#because it is unsupervised learning method.
#TASK: Accuracy = number of correctly classified/(total classified) = 133/150 = 88.67%
#i.e our model has achieved ?% accuracy!- Accuracy - 88.67%
