...
#How did the model do? Compared to the other algorithms, this was the model with the highest accuracy. The model
# correctly predicted all setosa species correctly.
#What is the accuracy rate?
# accuracy is at 97.33%
